...
//        Storing and Recalling Articles
...
function storeArticle () {
   ...
   // fetch code for storing a single article here
   // store commit[saveIDInt].Cities[0].city_names, commit[saveIDInt].Title,
   // and commit[saveIDInt].Url
